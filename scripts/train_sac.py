...
def main():
    config = SACConfig(TOTAL_TIMESTEPS=100_000, NUM_ENVS=16, BUFFER_SIZE=100_000, BATCH_SIZE=256, LEARNING_STARTS=1000, LR=1e-3, ENV_NAME="MountainCarContinuous-v0", SEED=42)
