...
This Atari-focused library now includes reusable DQN building blocks plus a small set of categorical distributional (C51) primitives, without yet wiring those pieces into the current DQN agent configuration.
...
- Provide a small categorical value head that emits action-by-atom logits for future agent wiring.
...
- No full agent-side C51 learner integration yet.
