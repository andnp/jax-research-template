...
class TestTypedJit:
    ...
    def test_preserves_output(self) -> None:
...
class TestTypedVmap:
    ...
    def test_with_axis_name(self) -> None:
    ...
    def test_combined_jit_vmap(self) -> None:
