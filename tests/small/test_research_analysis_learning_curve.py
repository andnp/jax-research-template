...
class TestStepWeightedReturns:
    def test_science_guide_worked_example_matches_copy_forward_curve(self) -> None:
    ...
    def test_one_episode_input_fills_all_steps(self) -> None:
    ...
    def test_non_monotonic_steps_raise_value_error(self) -> None:
        with pytest.raises(ValueError, match="strictly increasing"):
            step_weighted_returns(np.array([2, 5, 4]), np.array([1.0, 2.0, 3.0]))

    def test_duplicate_steps_raise_value_error(self) -> None:
    ...
    def test_end_step_extension_copies_forward_final_return(self) -> None:
        result = step_weighted_returns(
            np.array([2, 5]),
            np.array([1.0, 3.0]),
            end_step=8,
    ...
    def test_end_step_smaller_than_last_cumulative_step_raises(self) -> None:
...
class TestStepWeightedReturnsFromDataFrame:
    def test_happy_path_with_explicit_column_names(self) -> None:
        frame = pl.DataFrame(
            {
                "total_steps": [2, 5],
    ...
    def test_wrapper_matches_primitive(self) -> None:
    ...
    def test_missing_step_column_raises_value_error(self) -> None:
    ...
    def test_missing_return_column_raises_value_error(self) -> None:
    ...
    def test_nulls_in_selected_columns_raise_value_error(self) -> None:
        frame = pl.DataFrame(
            {
                "steps": [1, None],
                "returns": [1.0, 2.0],
    ...
    def test_non_integer_step_dtype_raises_type_error(self) -> None:
        frame = pl.DataFrame(
            {
                "steps": [1.0, 2.0],
                "returns": [1.0, 2.0],
    ...
    def test_unsorted_steps_still_fail_via_primitive(self) -> None:
        frame = pl.DataFrame(
            {
                "steps": [2, 5, 4],
                "returns": [1.0, 2.0, 3.0],
    ...
    def test_duplicate_steps_still_fail_via_primitive(self) -> None:
        frame = pl.DataFrame(
            {
                "steps": [2, 5, 5],
                "returns": [1.0, 2.0, 3.0],
